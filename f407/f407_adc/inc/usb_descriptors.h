...
constexpr uint8_t Device_Descriptor[18] =
    {
        ...
        0x10,0x01, // USBDeviceDescriptor_USB2_00
	...
	/*!<Communication interface>*/    
        /*Interface Descriptor master*/
        {
			...
			},
			{
				...
				0x82, /* bEndpointAddress IN  8-IN 1-endpoint1*/
...
//---------------------------------------------------------------------------------------------------	
	...
	constexpr uint8_t Man_String[38] = 
	{
		/* Index 0x01:  */
		38,   /*descriptor length = 13 */
        0x03,   /*STRING descriptor type */
        'S',0,
		'T',0,
		'M',0,
	...
	constexpr uint8_t Prod_String[44] = 
	{
		/* Index 0x02:  */
		44,   /*descriptor length = 14 */
        0x03,   /*STRING descriptor type */
        'S',0,
		'T',0,
		'M',0,
	...
	constexpr uint8_t SN_String[0x1A] = 
	{
		/* Index 0x03:  */
		0x1A,   /*descriptor length = 14 */
        0x03,   /*STRING descriptor type */
        '0',0,
		'0',0,
		'0',0,
...
//	"00000000001A"	
	...
	constexpr uint8_t USBD_CDC_DeviceQualifierDesc[0x0a] =
{
  0x0a,
  0x06,
  0x00,
