...
void GP_Timers::delay_us(uint32_t us) {
    us_counter = 0;
    while(us_counter < us){__ASM("nop");}    
}
...
extern "C" void TIM2_IRQHandler(void) {
    ...
    GP_Timers::pThis[0]->us_counter++;
    GP_Timers::pThis[0]->us_counter2++;
    if(GP_Timers::pThis[0]->us_counter2 >= 1000) {
        GP_Timers::pThis[0]->ms_counter++;
        GP_Timers::pThis[0]->us_counter2 = 0;
    }
}
