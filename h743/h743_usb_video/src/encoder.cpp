...
void Encoder::SM_step_forward() {
    SM_set_1(); GP_Timers::pThis[0]->delay_us(10000);
    SM_set_2(); GP_Timers::pThis[0]->delay_us(10000);
    SM_set_3(); GP_Timers::pThis[0]->delay_us(10000);
    SM_set_4(); GP_Timers::pThis[0]->delay_us(10000);
}
